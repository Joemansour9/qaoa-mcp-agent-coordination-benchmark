...
| `i1_i6_i11_analysis.py` / `.json` | The extended-predictor analysis for I1, I7, I8, I10, I11 (n=5): R, delta-r-bar (three definitions), and exact-permutation Spearman correlations, computed directly from the `results/` files above with nothing hardcoded. Source for Table `tab:extended_predictor` and reproduces its printed values exactly (r_s=-0.300/+0.100/-0.100, exact p=0.683/0.950/0.950). |
